  ...
  bslib::sidebar(
    ...
    bslib::accordion(
        ...
        htmltools::HTML(
          paste0(
            ...
            bslib::tooltip(
              ...
              "Set start and end dates of the period of interest. Then, click or tap 'RETRIEVE 15-MINUTE DATA'.",
      ...
      shiny::dateInput(
        inputId = "startDate",
        label = "Start Date",
        value = lubridate::today(tzone = "America/Phoenix") - lubridate::ddays(x = 2),
        min = az15minStartDate,
